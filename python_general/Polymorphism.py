...
b = 20
sum  = a.__add__(b)
print("original sum {}".format(sum))

# now we can modify function __add__
class number(object):
    def __init__(self, num):
        self.num =  num
    def __add__(self, other):
        total =  self.num + other.num + 10
        return total

num_a = number(10)
num_b = number(20)

sum = num_a.__add__(num_b)
print("modified sum {}".format(sum))
...
In this example, let’s create a function called “func()” which will take an object which we will name “obj”. Though we are using the name ‘obj’, 
any instantiated object will be able to be called into this function. Next, let’s give the function something to do that uses the ‘obj’ object we passed to it. 
