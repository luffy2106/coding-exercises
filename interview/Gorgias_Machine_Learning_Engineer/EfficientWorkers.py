...
def minCostPossibleListPairs(possible_list_pairs, minimum_cost):
...
def findMinCost(efficiency):
    # minimum_cost = pow(10,9) * pow(10,5)
    list_minimum_cost = []
    for exclude_worker in efficiency:
        ...
        minimum_cost_case = minCostPossibleListPairs(possible_list_pairs, minimum_cost_case)
